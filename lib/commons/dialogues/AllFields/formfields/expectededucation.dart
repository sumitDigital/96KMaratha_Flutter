...
class ShowAllExpectedEducation extends StatelessWidget {
  final List<dynamic> items;
  const ShowAllExpectedEducation({
    super.key,
    required this.items,
  });
              ...
              child: Row(
                ...
                children: [
                  ...
                  Flexible(
                    child: TextButton(
                      onPressed: () {
                        educationController.selectedEducationListTemp.clear();
                      },
                      child: Text(
                          ...
                          (index) {
                            ...
                            return Chip(
                              ...
                              onDeleted: () {
                                print("CANCLE delete");
                                educationController
                                    .toggleEducationSelectionTemp(item);
                              },
                            );
                          },
                        ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextButton(
                    onPressed: () {
                      print(
                          "THIS IS TEMP LIST ${educationController.selectedEducationListTemp.length}");
                      educationController.selectedEducationList.clear();
                      educationController.selectedEducationList.value.addAll(
                          educationController.selectedEducationListTemp.where(
                              (newItem) => !educationController
