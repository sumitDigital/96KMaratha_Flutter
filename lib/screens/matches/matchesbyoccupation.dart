...
class MatchesbyOccupation extends StatefulWidget {
  const MatchesbyOccupation({super.key});

  @override
  State<MatchesbyOccupation> createState() => _MatchesbyOccupationState();
}

class _MatchesbyOccupationState extends State<MatchesbyOccupation> {
  ...
  void initState() {
    ...
    _dashboardController.fetchMatchesbyOccupationList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.matchesbyOccupationList.isEmpty &&
            _dashboardController.matchesbyOccupationListfetching.value ==
                false) {
          return RefreshIndicator(
            onRefresh: () {
              return Future(() async {
                _dashboardController.recommendedbyOccupationpage.value = 1;
                _dashboardController.matchesByOccupationhasMore.value = true;
                _dashboardController.matchesbyOccupationList.clear();
                _dashboardController.matchesbyeducationListfetching.value =
                    true;

                await _dashboardController.fetchMatchesbyOccupationList();
              });
            },
            child: ListView(
              children: const [
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  _dashboardController.matchesbyOccupationList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index <
                    _dashboardController.matchesbyOccupationList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.matchesbyOccupationList[index];
                  ...
                  if (_dashboardController.matchesbyOccupationList.isEmpty &&
                      _dashboardController
                          .matchesbyOccupationListfetching.value) {
                    return Padding(
                        ...
                        return Padding(
                          ...
                          child: Center(
                              child: _dashboardController
                                      .matchesByOccupationhasMore.value
                                  ? Shimmer.fromColors(
                                      baseColor: Colors.grey[300]!,
                                      highlightColor: Colors.grey[100]!,
                                      child: Container(
                                      ...
                                      child: Text.rich(
                                        ...
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                                text:
                                                    "  All done! More profiles coming soon..! ",
                                                style: CustomTextStyle.title),
                                          ],
                                        ),
                                      ),
