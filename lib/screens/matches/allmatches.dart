...
class _AllMatchesState extends State<AllMatches> {
  ...
  void initState() {
    ...
    _dashboardController.fetchAllMatches();
      ...
      () {
        return RefreshIndicator(
          onRefresh: () {
            return Future(
              () async {
                _dashboardController.allMatchespage.value = 1;
                _dashboardController.allMatchesListhasMore.value = true;
                _dashboardController.allMatchesList.clear();

                await _dashboardController.fetchAllMatches();
              },
            );
          },
          child: ListView.builder(
            ...
            itemCount: _dashboardController.allMatchesList.length + 1,
            itemBuilder: (context, index) {
              // Check if the index is less than the data length
              if (index < _dashboardController.allMatchesList.length) {
                // Access the current match data
                var matchData = _dashboardController.allMatchesList[index];
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      matchData["is_Document_Verification"] == 1
