...
class RecommendedMatches extends StatefulWidget {
  const RecommendedMatches({super.key});

  @override
  State<RecommendedMatches> createState() => _RecommendedMatchesState();
}

class _RecommendedMatchesState extends State<RecommendedMatches> {
  ...
  void initState() {
    ...
    _dashboardController.fetchRecommendedMatchesList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.recommendedmatchesList.isEmpty &&
            _dashboardController.recommendedmatchesListfetching.value ==
                false) {
          return RefreshIndicator(
            onRefresh: () {
              return Future(() async {
                _dashboardController.recommendedpage.value = 1;
                _dashboardController.matchesByReccomendationhasMore.value =
                    true;
                _dashboardController.recommendedmatchesList.clear();
                _dashboardController.recommendedmatchesListfetching.value =
                    true;

                await _dashboardController.fetchRecommendedMatchesList();
              });
            },
            child: ListView(
              children: const [
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount: _dashboardController.recommendedmatchesList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index <
                    _dashboardController.recommendedmatchesList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.recommendedmatchesList[index];
                  ...
                  if (_dashboardController.recommendedmatchesList.isEmpty &&
                      _dashboardController
                          .recommendedmatchesListfetching.value) {
                    return Padding(
                        ...
                        return Padding(
                          ...
                          child: Center(
                              child: _dashboardController
                                      .matchesByReccomendationhasMore.value
                                  ? Shimmer.fromColors(
                                      baseColor: Colors.grey[300]!,
                                      highlightColor: Colors.grey[100]!,
                                      child: Container(
                                      ...
                                      child: Text.rich(
                                        ...
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                                text:
                                                    "  No more profiles. New profiles will be added soon. ",
                                                style: CustomTextStyle.title),
                                          ],
                                        ),
                                      ),
