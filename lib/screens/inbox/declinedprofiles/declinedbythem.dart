...
class DeclinedProfilesByThem extends StatefulWidget {
  const DeclinedProfilesByThem({super.key});

  @override
  State<DeclinedProfilesByThem> createState() => _DeclinedProfilesByThemState();
}

class _DeclinedProfilesByThemState extends State<DeclinedProfilesByThem> {
  ...
  void initState() {
    ...
    _dashboardController.fetchDeclinedByThemList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.declinedbyThemProfilesList.isEmpty &&
            _dashboardController.declinedbyThemprofilesListFetching.value ==
                false) {
          return RefreshIndicator(
            onRefresh: () {
              return Future(() async {
                _dashboardController.declinedbyThemProfilePage.value = 1;
                _dashboardController.declinedbyThemProfileshasMore.value = true;
                _dashboardController.declinedbyThemProfilesList.clear();
                _dashboardController.declinedbyThemprofilesListFetching.value =
                    true;

                await _dashboardController.fetchDeclinedByThemList();
              });
            },
            child: ListView(
              children: [
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  _dashboardController.declinedbyThemProfilesList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index <
                    _dashboardController.declinedbyThemProfilesList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.declinedbyThemProfilesList[index];
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  ...
                                                  " ${language == "en" ? "${mybox.get("gender") == 2 ? "He" : "She"} Declined your Invitation. This member cannot be contacted. !" : "${mybox.get("gender") == 2 ? "त्याने " : "तिने"} तुमचा इंटरेस्ट नाकारला आहे. तुम्ही त्यांना संपर्क करू शकत नाही."}",
                  ...
                  if (_dashboardController.declinedbyThemProfilesList.isEmpty &&
                      _dashboardController
                          .declinedbyThemprofilesListFetching.value) {
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
                    ...
                    return GetBuilder<DashboardController>(
                      id: 'no_more_data_for_declinedbythem',
                      builder: (controller) {
                        return Padding(
