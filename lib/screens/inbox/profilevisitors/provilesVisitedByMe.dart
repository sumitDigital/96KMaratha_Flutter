...
class ProfileVisitedByMe extends StatefulWidget {
  const ProfileVisitedByMe({super.key});

  @override
  State<ProfileVisitedByMe> createState() => _ProfileVisitedByMeState();
}

class _ProfileVisitedByMeState extends State<ProfileVisitedByMe> {
  ...
  void initState() {
    ...
    _dashboardController.fetchProfilesVisitedByMeList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.profilesvisitedByMeList.isEmpty &&
            _dashboardController.profilesvisitedByMeListFetching.value ==
                false) {
          return RefreshIndicator(
            onRefresh: () {
              return Future(() async {
                _dashboardController.profilesvisitedByMePage.value = 1;
                _dashboardController.profilesvisitedByMehasMore.value = true;
                _dashboardController.profilesvisitedByMeList.clear();
                _dashboardController.profilesvisitedByMeListFetching.value =
                    true;

                await _dashboardController.fetchProfilesVisitedByMeList();
              });
            },
            child: ListView(
              children: [
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  _dashboardController.profilesvisitedByMeList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index <
                    _dashboardController.profilesvisitedByMeList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.profilesvisitedByMeList[index];
                  ...
                  if (_dashboardController.profilesvisitedByMeList.isEmpty &&
                      _dashboardController
                          .profilesvisitedByMeListFetching.value) {
                    return Padding(
                        ...
                        return Padding(
                          ...
                          child: Center(
                              child: _dashboardController
                                      .profilesvisitedByMehasMore.value
                                  ? Shimmer.fromColors(
                                      baseColor: Colors.grey[300]!,
                                      highlightColor: Colors.grey[100]!,
                                      child: Container(
