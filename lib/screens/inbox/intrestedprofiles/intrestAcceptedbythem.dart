...
class IntrestAcceptedByThem extends StatefulWidget {
  const IntrestAcceptedByThem({super.key});

  @override
  State<IntrestAcceptedByThem> createState() => _IntrestAcceptedByThemState();
}

class _IntrestAcceptedByThemState extends State<IntrestAcceptedByThem> {
  ...
  void initState() {
    ...
    // _dashboardController.fetchIntrestAcceptedbyThemList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.intrestAcceptedByThemList.isEmpty &&
            _dashboardController.intrestAcceptedbythemfetching.value == false) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  _dashboardController.intrestAcceptedByThemList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index <
                    _dashboardController.intrestAcceptedByThemList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.intrestAcceptedByThemList[index];
                                        ...
                                        child: Padding(
                                          ...
                                          child: Center(
                                            child: Text(
                                                ...
                                                "$gender accepted your interest. Take the next step to connect with them.",
                                                style:
                  ...
                  if (_dashboardController.intrestAcceptedByThemList.isEmpty &&
                      _dashboardController
                          .intrestAcceptedbythemfetching.value) {
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
