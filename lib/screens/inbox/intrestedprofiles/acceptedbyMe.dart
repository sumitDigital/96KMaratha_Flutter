...
class IntrestAcceptedByMe extends StatefulWidget {
  const IntrestAcceptedByMe({super.key});

  @override
  State<IntrestAcceptedByMe> createState() => _IntrestAcceptedByMeState();
}

class _IntrestAcceptedByMeState extends State<IntrestAcceptedByMe> {
  ...
  void initState() {
    ...
    //_dashboardController.fetchIntrestAcceptedList();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (_dashboardController.intrestAcceptedList.isEmpty &&
            _dashboardController.intrestAcceptedfetching.value == false) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount: _dashboardController.intrestAcceptedList.length + 1,
              itemBuilder: (context, index) {
                // Check if the index is less than the data length
                if (index < _dashboardController.intrestAcceptedList.length) {
                  // Access the current match data
                  var matchData =
                      _dashboardController.intrestAcceptedList[index];
                                        ...
                                        child: Padding(
                                          ...
                                          child: Center(
                                            child: Text(
                                                ...
                                                language == "en"
                                                    ? "You accepted his interest. Now you can connect with this profile. "
                                                    : "तुम्ही या प्रोफाईलचा इंटरेस्ट स्वीकारला आहे. तुम्ही या प्रोफाईलला कनेक्ट करू शकतात.",
                                                style:
                  ...
                  if (_dashboardController.intrestAcceptedList.isEmpty &&
                      _dashboardController.intrestAcceptedfetching.value) {
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
