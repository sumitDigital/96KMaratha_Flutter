...
class PresentSelectCityScreen extends StatefulWidget {
  const PresentSelectCityScreen({super.key, required this.stateId});
  final String stateId;

  @override
  State<PresentSelectCityScreen> createState() =>
      _PresentSelectCityScreenState();
}

class _PresentSelectCityScreenState extends State<PresentSelectCityScreen> {
          ...
          child: Column(
            children: [
              ...
              Obx(() {
                ...
                // Check if there is a selected city and reorder the list accordingly

                if (_locationController.cityLoading.value) {
                  return Expanded(
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Obx(() {
                                ...
                                //          city.id
                                // Highlight the tile if the city is selected
                                return ListTile(
                                  trailing: Checkbox(
                                  ...
                                  onTap: () {
                                    ...
                                    _locationController
                                        .presentselectedCity.value = city;
                                    _locationController.presentcityID.value =
                                        city.id ?? 0;
                                  },
                                );
                              });
      ...
      floatingActionButton: ElevatedButton(
        onPressed: () {
          if (_locationController.presentselectedCity.value.id == null) {
            ...
            // Navigate back and store the selected city ID
            Get.back();
            Get.back();
            Get.back();
          }
