...
class EditPartnerPrefrances extends StatefulWidget {
  const EditPartnerPrefrances({super.key});

  @override
  State<EditPartnerPrefrances> createState() => _EditPartnerPrefrancesState();
}

class _EditPartnerPrefrancesState extends State<EditPartnerPrefrances> {
  String? selectedHeight;

  final EditPartnerExpectation _stepThreeController =
   ...
   ScrollController controller = ScrollController(
    ...
    return WillPopScope(
                          ...
                          iconEnabledColor: Colors.grey, // Color of the dropdown icon
                              ...
                              Obx(() {
                                ...
                                if (_castController
                                  ...
                                  final TextEditingController caste =
                                      TextEditingController(
                              ...
                              //   // Check if selectedSectionStringList is empty
                              //   if (_castController
                              //       .selectedSubSectionList.isEmpty) {
                              //     // If no sections selected, show the CustomTextField to select sections
                              //     return CustomTextField(
                              //       validator: (value) {
                              //         if (value == null || value.isEmpty) {
                                  ...
                                  if (_educationController
                                    ...
                                    return CustomTextField(
                                      validator: (value) {
                                        if (value == null || value.isEmpty) {
                                          return language == "en"
                                              ? "Please select your partner's expected highest education"
                                              : 'कृपया जोडीदाराचे अपेक्षित शिक्षण निवडा';
                                        }
                                        return null;
                                      },
                                      HintText: language == "en"
                                          ? "Select Partner's Highest Degree"
                                          : "जोडीदाराचे शिक्षण निवडा ",
                                      ontap: () {
                                        _showEducationBottomSheet(context);
                                      },
                                      // textEditingController: highDegree,
                                      readonly: true,
                                    );
                                  }
                                },
      ...
      */
                              ...
                              //                   left: 18.0),
                              //               child: Text(
                              //                 "Please select your partner's expected dietary habits",
                              ...
                              //       GestureDetector(
                              //         onTap: () {
                              //           _stepThreeController.updateSmokingHabit(
                              ...
                              //                   left: 18.0),
                              //               child: Text(
                              //                 "Please select your partner's expected smoking habits",
                              //                 style: CustomTextStyle.errorText,
                              //               ),
                              //             )
                              //           ],
                              ...
                              //                   left: 18.0),
                              //               child: Text(
                              //                 "Please select your partner's expected drinking habits",
                              //                 style: CustomTextStyle.errorText,
                              //               ),
                              //             )
                              //           ],
                  ...
                  children: [
                    ...
                    Center(
                      child: Text(
                          textAlign: TextAlign.center,
                          language == "en"
                              ? "select at least 4 occupations"
                              : "कमीत कमी ४ व्यवसाय निवडा",
                    ...
                    Center(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              AppLocalizations.of(context)!.searchOccupation,
                    ...
                    TextFormField(
                      validator: (value) {
                        if (_educationController.selectedEducationList.length <
                            4) {
                          return 'Please select at least 4 educations';
                        }
                        return null;
                      },
                      onChanged: (value) {
